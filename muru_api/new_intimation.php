...
if ($id == NULL) {
    ...
    triggers, claimno, insurance_tpa, policy_type, doj, claim_type, case_type, fees, mrd, transportation,created,created_by,invoice,incentive,payment) 
   ...
   '$values[18]','$values[19]','$values[23]','admin',$invoice,'$incentive','$payment')");
    ...
    doi='$values[6]',opno='$values[7]',ipno='$values[8]',hosp_details='$values[9]', incentive='$incentive',payment='$payment',
